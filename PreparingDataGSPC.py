...
with open('C:/Users/Dell/Desktop/BE/DataGathered/HistoricalData/GSPC.csv', 'r') as csvfile:
...
for year in years:
    for month in months:
        file_str = 'C:/Users/Dell/Desktop/BE/DataGathered/HistoricalData/' + str(year) + '-' + '{:02}'.format(month) + '.json'
...
interpolated_df.to_pickle('C:/Users/Dell/Desktop/BE/DataGathered/ProcesssedData/pickled_ten_year_filtered_lead_para_GSPC.pkl')  


# Save pandas frame in csv form
interpolated_df.to_csv('C:/Users/Dell/Desktop/BE/DataGathered/ProcesssedData/sample_interpolated_df_10_years_filtered_lead_para_GSPC.csv',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('C:/Users/Dell/Desktop/BE/DataGathered/ProcesssedData/pickled_ten_year_filtered_lead_para_GSPC.pkl')
